...
document.addEventListener("click", function (e) {
    ...
    // Check if clicked element matches the TreeView content selector
    if (e.target.closest("#t_Body_nav .a-TreeView-content")) {

        var node = e.target.closest(".a-TreeView-node");
        var toggle = node.querySelector(".a-TreeView-toggle");
